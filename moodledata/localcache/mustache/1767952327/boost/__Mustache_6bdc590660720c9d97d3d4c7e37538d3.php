...
class __Mustache_6bdc590660720c9d97d3d4c7e37538d3 extends Mustache_Template
{
...
';
        ...
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionC6459efd699ce159d6b4cdb87b9e616c($context, $indent, $value);
        $buffer .= $indent . '                           
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function sectionC6459efd699ce159d6b4cdb87b9e616c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
